<script lang="ts">
    ...
    import { AtSign, Code, MessageSquare } from 'lucide-svelte'; // Assuming you might use these!

    const socialLinks = [
        {
            label: "GitHub",
            href: "https://github.com/pring-nt/Quiver",
            icon: Code
        },
        {
            label: "Instagram",
...
<BaseDialog
        ...
        description="Have suggestions, found a bug, or just want to see the code? Connect below!"
        icon={AtSign}
>
    <!-- The Trigger Button -->
    {#snippet trigger()}
